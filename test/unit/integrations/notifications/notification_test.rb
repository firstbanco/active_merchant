...
class NotificationTest < Test::Unit::TestCase
  ...
  def test_valid_sender_ignore_test_mode
    ActiveMerchant::Billing::Base.integration_mode = :test
    @notification.production_ips = ['1.2.3.4']
    assert @notification.valid_sender?('1.2.3.5')
    assert !@notification.valid_sender?('1.2.3.5', ignore_test_mode: true)
  end
